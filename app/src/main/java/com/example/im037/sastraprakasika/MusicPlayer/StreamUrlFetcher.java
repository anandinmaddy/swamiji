...
import com.example.im037.sastraprakasika.MusicPlayer.Config.URLS;
import com.example.im037.sastraprakasika.MusicPlayer.Config.VolleyUtils;
                        ...
                        try {
                            ...
                            if (obj.getInt("status") == 200) {
                                ...
                                if(onStreamUriFetchedListener!=null){   // For Auto-next
                                    onStreamUriFetchedListener.onUriAvailable( obj.getString("url"));
                                }
