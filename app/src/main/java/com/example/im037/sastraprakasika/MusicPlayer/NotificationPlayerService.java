...
public class NotificationPlayerService extends Service {
    ...
    private void showNotification() {
        ...
        Intent notificationIntent = new Intent(this, MyLibraryActivity.class);
        ...
        if (PLAYING) {
            ...
            view.setImageViewResource(R.id.notification_player_play_pauseBtn, R.drawable.ic_pause_notification);
            view.setImageViewResource(R.id.notification_player_nextBtn, R.drawable.ic_next_notification);
            ...
            bigView.setImageViewResource(R.id.notification_player_play_pauseBtn, R.drawable.ic_pause_notification);
            bigView.setImageViewResource(R.id.notification_player_nextBtn, R.drawable.ic_next_notification);
            ...
            view.setImageViewResource(R.id.notification_player_play_pauseBtn, R.drawable.ic_play_notification);
            view.setImageViewResource(R.id.notification_player_nextBtn, R.drawable.ic_next_notification);
            view.setTextViewText(R.id.notification_player_title, title);
            view.setTextViewText(R.id.notification_player_subtitle, subtitle);
            ...
            bigView.setImageViewResource(R.id.notification_player_play_pauseBtn, R.drawable.ic_play_notification);
            bigView.setImageViewResource(R.id.notification_player_nextBtn, R.drawable.ic_next_notification);
...
//        notification.icon = R.mipmap.inotify;
        ...
        Picasso.get().load(streamThumbnailUrl).into(view, R.id.notification_player_thumbnail, Constants.NOTIFICATION_ID.FOREGROUND_SERVICE, notification);
        Picasso.get().load(streamThumbnailUrl).into(bigView, R.id.notification_player_thumbnail, Constants.NOTIFICATION_ID.FOREGROUND_SERVICE, notification);
