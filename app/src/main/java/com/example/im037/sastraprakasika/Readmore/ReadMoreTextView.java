package com.example.im037.sastraprakasika.Readmore;
...
public class ReadMoreTextView extends TextView {
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ReadMoreTextView_trimCollapsedText, R.string.show);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(R.styleable.ReadMoreTextView_trimExpandedText, R.string.less);
