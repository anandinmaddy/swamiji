...
public class ConstantValues {
    ...
    public static String SERVER_URL = "http://www.imaginetventures.name/swamiji/api/users/";
    public static String LOGIN = SERVER_URL + "login";
    public static String SOCIAL_LOGIN = SERVER_URL + "social_login";
    public static String REGISTER = SERVER_URL + "register";
    public static String OTP_CODE = SERVER_URL + "login_register_otpcode";
    public static String CONFIRM_OTP = SERVER_URL + "check_otpcode";
    ...
    public static String PAYMENT_LIST =SERVER_URL+"payment_complete";

    public static String PAYMENTVERI_LIST =SERVER_URL+"payment_verification";
