...
import com.sastra.im037.sastraprakasika.Fragment.VolumePageFragment.OnListFragmentInteractionListener;
import com.sastra.im037.sastraprakasika.Fragment.dummy.DummyContent.DummyItem;
...
public class MyVolumePageRecyclerViewAdapter extends RecyclerView.Adapter<MyVolumePageRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_volumepage, parent, false);
