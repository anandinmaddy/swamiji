...
public class HelpSupportActivity extends CommonActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setView(R.layout.activity_privacy_policy, "Help & Support");
    ...
    public void SetAboutDetail() {
        new WebServices(HelpSupportActivity.this, TAG).getAboutPageDetails("1905", new VolleyResponseListerner() {
